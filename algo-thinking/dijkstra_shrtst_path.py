...
# Used to find the shortest path in a weighted graph (to every node from origin)
# Optimal and uses a greedy approach
# Weights must be positive to gaurantee correct results
