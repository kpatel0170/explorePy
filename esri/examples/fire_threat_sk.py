...
positives, then buffers -> dissolves -> smooths into nested cloud polygons
categorized by hotspot age (<24h, 24-48h, 48-96h, >96h).

Run:
    export FIRMS_MAP_KEY=...        # free key: https://firms.modaps.eosdis.nasa.gov/api/
    python esri/examples/fire_threat_sk.py
